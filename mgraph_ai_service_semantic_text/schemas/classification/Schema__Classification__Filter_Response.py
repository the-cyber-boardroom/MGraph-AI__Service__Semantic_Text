...
class Schema__Classification__Filter_Response(Type_Safe):                                    # Response with filtered hashes based on criteria
    ...
    filtered_with_text      : Dict[Safe_Str__Hash, str]                              = None  # Hash → text mapping (if output_mode includes text)
    filtered_with_ratings   : Dict[Safe_Str__Hash, Safe_Float__Text__Classification] = None  # Hash → rating mapping (if output_mode includes ratings)
