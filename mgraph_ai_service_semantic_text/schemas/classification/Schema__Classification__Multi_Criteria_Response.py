...
class Schema__Classification__Multi_Criteria_Response(Type_Safe):                                   # Response with multiple criteria ratings for all hashes
    hash_ratings               : Dict[Safe_Str__Hash, Dict[Enum__Text__Classification__Criteria,
                                                           Safe_Float__Text__Classification    ]]   # Hash → {criterion → rating}
    classification_criteria    : List[Enum__Text__Classification__Criteria]                         # Criteria used for classification
