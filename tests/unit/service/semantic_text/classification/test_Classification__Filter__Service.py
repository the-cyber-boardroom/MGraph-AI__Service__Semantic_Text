...
class test_Classification__Filter__Service(TestCase):
    ...
    def test__classify_all__basic(self):                                       # Test basic classification of all hashes
        hash_mapping = {Safe_Str__Hash("abc1234567"): Safe_Str__Comprehend__Text("Hello World"),
                        Safe_Str__Hash("def1234567"): Safe_Str__Comprehend__Text("Test Text")}
    ...
    def test__classify_all__single_hash(self):                                 # Test with single hash
        hash_mapping = {Safe_Str__Hash("abc1234567"): Safe_Str__Comprehend__Text("Single text")}
    ...
    def test__filter_by_criteria__above__hashes_only(self):                    # Test ABOVE filter with HASHES_ONLY output
        hash_mapping = {Safe_Str__Hash("abc1234567"): Safe_Str__Comprehend__Text("Positive text.."),
                        Safe_Str__Hash("def1234567"): Safe_Str__Comprehend__Text("Negative text.")}
    ...
    def test__filter_by_criteria__above__with_text(self):                      # Test ABOVE filter with HASHES_WITH_TEXT output
        hash_mapping = {Safe_Str__Hash("abc1234567"): Safe_Str__Comprehend__Text("Test")}
    ...
    def test__filter_by_criteria__above__full_ratings(self):                   # Test ABOVE filter with FULL_RATINGS output
        ...
        assert response.obj()                 == __(filtered_hashes           = ['abc1234567']                      ,
                                                    filtered_with_text        = __(abc1234567 = 'Test')              ,
                                                    filtered_with_ratings     = __(abc1234567 = __(positive = 0.4257015636325981  ,
    ...
    def test__filter_by_criteria__below(self):                                  # Test BELOW filter mode
        hash_mapping = {Safe_Str__Hash("abc1234567"): Safe_Str__Comprehend__Text("Text A"),  # positive=0.3969413061449435
                        Safe_Str__Hash("def1234567"): Safe_Str__Comprehend__Text("Text B")}  # positive=0.616592082616179
    ...
    def test__filter_by_criteria__between(self):                                # Test BETWEEN filter mode
        hash_mapping = {Safe_Str__Hash("aaa1234567"): Safe_Str__Comprehend__Text("Text A"),  # positive=0.3969413061449435
                        Safe_Str__Hash("bbb1234567"): Safe_Str__Comprehend__Text("Text B"),  # positive=0.616592082616179
                        Safe_Str__Hash("ccc1234567"): Safe_Str__Comprehend__Text("Text C")}  # positive=0.1645044724838576
    ...
    def test__filter_by_criteria__equals(self):                                     # Test EQUALS filter mode
        hash_mapping = {Safe_Str__Hash("abc1234567"): Safe_Str__Comprehend__Text("Text")}  # positive=0.6001957083944922
        ...
        def check_tolerance(tolerance, should_match):
            ...
            response_2        = self.classification_filter_service.filter_by_criteria(request     = request         ,
                                                                                      engine_mode = self.engine_mode)
            assert (response_2.obj() == response.obj()) is should_match

        # These will still match because we are within FLOAT__CLASSIFICATION__FILTER__EQUALS__TOLERANCE (0.001)
        ...
        # These do not match because they are outside the tolerance of 0.001
