# MGraph AI Service Semantic_Text

[![Current Release](https://img.shields.io/badge/release-v0.5.0-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Semantic_Text/releases)
...
[![CI Pipeline - DEV](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Semantic_Text/actions/workflows/ci-pipeline__dev.yml/badge.svg)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Semantic_Text/actions)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__Semantic_Text](docs/dev/non-functional-requirements/version-1_0_0/README.md).
...
# Run with coverage
pytest --cov=mgraph_ai_service_semantic_text
...
- 🐛 Issues: [GitHub Issues](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Semantic_Text/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Semantic_Text/discussions)
