...
git remote add template https://github.com/org/MGraph-AI__Service__Semantic_Text.git
```
...
git fetch template
git checkout template/main -- mgraph_ai_service_semantic_text/routes/health.py
